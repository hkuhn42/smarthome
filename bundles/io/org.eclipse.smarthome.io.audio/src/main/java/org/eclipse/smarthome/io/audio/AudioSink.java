...
/**
 * Definition of an audio output like headphones, a speaker or for a writing to
 * a file / clip Also used by recognition service
 *
...
public interface AudioSink {
	 ...
	 *
	 * If the passed {@link AudioSource} has a {@link AudioFormat} not supported
	 * by this instance, an {@link UnsupportedAudioFormatException} is thrown.
	 *
	 * @return A boolean indicating processing started
	 * @throws UnsupportedAudioFormatException
	 *             If audioSource format is not supported
	 */
